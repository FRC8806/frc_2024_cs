...
public class SwerveModule {
    ...
    public SwerveModuleState getState() {
        return new SwerveModuleState(
                throttle.getVelocity().getValue() * Constants.kThrottleVelocityConversionFactor,
    ...
    public void setState(SwerveModuleState states) {
        ...
        double throttleOutput = optimizedState.speedMetersPerSecond / Constants.kMaxThrottleSpeed;
    ...
    double throttlePosition = throttle.getPosition().getValue() * Constants.kThrottlePositionConversionFactor;
    return new SwerveModulePosition(throttlePosition, Rotation2d.fromRotations(encoder.getAbsolutePosition().getValue()));
  }
